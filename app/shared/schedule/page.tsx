      ...
      <div className="flex-1 container mx-auto p-6">
        <div className="mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-blue-600">Calendario de Tareas</h1>
              <p className="text-sm text-gray-500">Gestión y programación de actividades</p>
            </div>
          </div>
        </div>

        <div className="h-[calc(100vh-12rem)] bg-white rounded-xl shadow-lg overflow-hidden border-l-4 border-blue-500">
          <Calendar 
            tasks={tasks} 
