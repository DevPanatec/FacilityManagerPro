...
-- Create unique index for the composite foreign key
CREATE UNIQUE INDEX idx_contingency_types_id_org ON contingency_types(id, organization_id);

-- Add type_id to contingencies table
