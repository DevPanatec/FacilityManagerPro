-- Actualizar la función para permitir que los superadmins vean todos los chats
...
BEGIN
    ...
    accessible_rooms AS (
        -- Para superadmin, obtener todas las salas
        SELECT r.* 
        FROM chat_rooms r
        WHERE v_user_role = 'superadmin'
        UNION
        -- Para otros usuarios, obtener solo las salas donde son miembros
        SELECT r.*
        FROM chat_rooms r
...
-- Actualizar la función de mensajes para permitir que los superadmins vean todos los mensajes
