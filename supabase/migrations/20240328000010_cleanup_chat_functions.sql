...
DROP FUNCTION IF EXISTS get_chat_messages(p_room_id UUID, p_limit INTEGER, p_offset INTEGER);
DROP FUNCTION IF EXISTS get_chat_messages(room_uuid UUID, msg_limit INTEGER, msg_offset INTEGER);

-- Crear una única función con un nombre y parámetros únicos
