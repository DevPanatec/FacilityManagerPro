-- Revocar permisos específicos de las funciones de chat
...
REVOKE ALL ON FUNCTION get_org_admins() FROM PUBLIC;

-- Recrear función get_user_chat_rooms
...
-- Recrear función get_org_admins
